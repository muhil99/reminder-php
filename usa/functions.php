...
function getEvents($date = "")
{
    ...
    global $db;
    $query =
        "SELECT tamil_year, tamil_month,  tamil_ritu, solstice, solar, lunar, date, rahukalam, yamakandam, gulikai,lagnam,tyajyam,sun, sun_rashi, sun_transit,thithi, thithi_end, nakshatra,nakshatra_starttime,yogam, photo_url,aphoto_url,pphoto_url  FROM usa_events WHERE date = ? AND status = 1";
